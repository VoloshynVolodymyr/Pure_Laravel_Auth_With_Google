    ...
    <header class="flex items-center justify-between p-6">
        ...
        <div>
            <a href="{{ route('register') }}"
               class="rounded-md bg-green-600 py-2 px-4 font-semibold text-white shadow-lg transition duration-150 ease-in-out hover:bg-green-700 hover:shadow-xl focus:shadow-xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2">Register</a>
        </div>
    </header>
    <main class="flex flex-col justify-center p-6 pb-12">
        ...
        <div
                ...
                <div class="mb-6">
                    ...
                    <div class="relative mt-1 rounded-md shadow-sm">
                        ...
                        <input type="email" id="email" name="email" value="{{ old('email') }}" required autofocus
                               class="{{ $errors->has('email') ? 'text-red-900 placeholder-red-300 focus:border-red-500 focus:ring-red-500 border-red-300' : 'border-gray-300 focus:border-green-500 focus:ring-green-500 placeholder:text-gray-400' }} w-full rounded-md pl-10 text-sm focus:border-green-500 focus:outline-none focus:border-green-500 focus:ring-green-500 focus:ring-2 h-6 sm:h-8"
                ...
                <div class="flex items-center justify-between mb-6">
                    <div class="flex items-center gap-1 sm:gap-2">
                        <input type="checkbox" id="remember" name="remember"
                               class="h-4 w-4 rounded border-gray-300 text-green-600 focus:ring-green-500 focus:border-green-500"/>
                        <label for="remember" class="text-xs sm:text-sm text-gray-900">Remember me</label>
                    </div>
                    <a href="{{ route('password.request') }}"
                       class="text-xs sm:text-sm font-medium text-green-600 hover:text-green-500">Forgot your
                        password?</a>
                </div>

                <div>
                    <button type="submit"
                            class="flex w-full items-center justify-center rounded-md bg-green-600 py-2 px-4 font-semibold text-white shadow-lg transition duration-150 ease-in-out hover:bg-green-700 hover:shadow-xl focus:shadow-xl">
                        Log In
                    </button>
                </div>
            </form>
            ...
            <div class="mt-6 flex items-center justify-center">
                <a href="{{ route('register') }}" class="text-sm font-medium text-green-600 hover:text-green-500">Not
                    registered yet?</a>
            </div>

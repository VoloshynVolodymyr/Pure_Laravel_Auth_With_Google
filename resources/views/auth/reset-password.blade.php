        ...
        <form action="{{ route('password.update') }}" method="post" autocomplete="off">
            ...
            <div class="mb-6">
                ...
                <div class="relative mt-1 rounded-md shadow-sm">
                    ...
                    <input type="email" id="email" name="email" value="{{ old('email', $request->email) }}" required autofocus class="{{ $errors->has('email') ? 'text-red-900 placeholder-red-300 focus:border-red-500 focus:ring-red-500 border-red-300' : 'border-gray-300 focus:border-green-500 focus:ring-green-500 placeholder:text-gray-400' }} w-full rounded-md pl-10 text-sm h-6 sm:h-8 focus:border-green-500 focus:outline-none focus:border-green-500 focus:ring-green-500 focus:ring-2" placeholder="john@example.com" />
                    @error('email')
            ...
            <div class="mb-6">
                ...
                <div class="relative mt-1 rounded-md shadow-sm">
                    ...
                    <input type="password" id="password" name="password" required class="{{ $errors->has('password') ? 'text-red-900 placeholder-red-300 focus:border-red-500 focus:ring-red-500 border-red-300' : 'border-gray-300 focus:border-green-500 focus:ring-green-500 placeholder:text-gray-400' }} w-full rounded-md pl-10 text-sm h-6 sm:h-8 focus:border-green-500 focus:outline-none focus:border-green-500 focus:ring-green-500 focus:ring-2" placeholder="Minimum 8 characters" />
                    @error('password')
                    <div class="absolute inset-y-0 right-0 flex items-center pr-3">
                        <svg class="h-5 w-5 text-red-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                            <path fill-rule="evenodd" d="M2.25 12c0-5.385 4.365-9.75 9.75-9.75s9.75 4.365 9.75 9.75-4.365 9.75-9.75 9.75S2.25 17.385 2.25 12zM12 8.25a.75.75 0 01.75.75v3.75a.75.75 0 01-1.5 0V9a.75.75 0 01.75-.75zm0 8.25a.75.75 0 100-1.5.75.75 0 000 1.5z" clip-rule="evenodd" />
